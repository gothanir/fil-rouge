    ...
    <table class="tableCat">
        ...
        foreach ( $pictures as $picture) {
            ...
            <tr>
                ...
                <td class="borderTD" ><a class="modif" href="index.php?page=pictureModif&idpicture=<?php echo $picture['id']?>" >MODIFIER</a></td>
                <td class="borderTD" ><a class="suppr" href="index.php?page=picture&idpicturesuppr=<?php echo $picture['id']?>" 
                onclick='return(confirm("Voulez-vous supprimer cet sous-picture ?"))'>SUPPRIMER</a></td>
            </tr>
            <?php
        }
        ?>
