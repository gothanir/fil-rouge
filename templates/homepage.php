...
<header>
    ...
    <div class="end" href="index.php?page=connexion">
        <img href="index.php?page=connexion" class="logoConnection" src="../assets/uploads/login.png">
...
<nav>
    <ul>
        <li>
            <a class="sm">Jeux<img class="flecheDown" src="../assets/uploads/down.png"></a>
            <ul>
    ...
    <ul>
        <li>
            <a class="sm">DLC<img class="flecheDown" src="../assets/uploads/down.png"></a>
            <ul>
                <li><a class="fontHover" href="">categorie 1</a></li>
                <li><a class="fontHover" href="">categorie 2</a></li>
                <li><a class="fontHover" href="">categorie 3</a></li>
...
<img class="banniere" src="../assets/uploads/banniere.jpg">
